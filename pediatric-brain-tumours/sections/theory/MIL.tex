...
\textcite{Schirris2022} propose Variance MIL (VarMIL) which adds a learnable attention-weighted variance,
\begin{equation}
...
For example, medulloblastoma is mostly found in the fourth ventricle or cerebellar parenchyma~\cite{Millard2016}.
...
The text embedding can be created in various ways\footnote{See \textcite{Khattak2019} for a review.}.

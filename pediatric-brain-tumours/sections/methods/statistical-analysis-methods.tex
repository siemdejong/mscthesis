...
Text is embedded with TinyClinicalBERT~\sidecite{Rohanian2023}, provided by Huggingface Transformers~\sidecite{Wolf2020}, using its \texttt{[CLS]}-token.\sidenote{TinyClinicalBERT is trained on the critical care MIMIC-III database \cite{Johnson2016}}

...
This is useful if only one biomedical image is available.\marginpar{If denoised is used, move parts of this section to a theory section and refer to it here.}

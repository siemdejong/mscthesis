...
A recent study aims to show the connection between collagen density and stretch \sidecite{Zhou2023}.
...
For example, the flexibility of skin tissue prior to excision determines the amount of manual continuous or cyclic stretching needed to close a gap after excision~\sidecite{Verhaegen2012}.

Efforts to develop such a model have already been made by Soylu~\sidecite{Soylu2022}.
...
A human expert might recognize straight collagen fibrils as a stiff network~\sidecite{Holzapfel2001}, but it is interesting to see if an AI explains stiffness in the same manner.
